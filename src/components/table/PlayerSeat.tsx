...
export function PlayerSeat({ player, isCurrentPlayer, isDeclarer, isPartner, partnerRevealed }: PlayerSeatProps) {
  return (
    <div className={`flex flex-col items-center gap-1 ${isCurrentPlayer ? 'ring-2 ring-yellow-400 rounded-lg p-2' : 'p-2'}`}>
      <div className="flex items-center gap-2">
        ...
        {isDeclarer && <span className="text-xs bg-yellow-600 text-white px-2 py-0.5 rounded">Declarer</span>}
